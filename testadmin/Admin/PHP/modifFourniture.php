...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    function fileupload($save){
        ...
        if ($_FILES['imgProduit']['type'] !== ""){
            ...
            move_uploaded_file($_FILES['imgProduit']['tmp_name'], '../../img/Fourniture.'.$back);
    ...
    {
    $file_name='../../en/jsonEN/Fourniture.json';
    }
    ...
    if(file_put_contents("$file_name", get_data())) {
        ...
        if(file_put_contents("$file_name", get_dataG())) {
            ...
            if(file_put_contents("$file_name", get_dataGC())) {
                $file_name='../../fr/jsonFR/formatFourniture.json';
                $file='../../fr/jsonFR/formatFourniture.json';
                ...
                if(file_put_contents("$file_name", fileupload($file))){
                    ...
                    if(file_put_contents("$file_name", fileuploadG($file))){
                        $redirect_page = '/Admin/Produit/modifFourniture.html';
