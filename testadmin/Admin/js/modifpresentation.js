...
function changetextP(site){
  ...
  document.getElementById('P1').value = deleteslash(site[langage]["Presentation1"]);
  document.getElementById('P2').value = deleteslash(site[langage]["Presentation2"]);
  document.getElementById('P3').value = deleteslash(site[langage]["Presentation3"]);
  edit();
}
...
function editText1() {
  ...
  Text1.innerHTML = Text1Origine.value + '<img id="T1" class="edit" src="/img/edit.png">';
  Text1Origine.remove();
...
function reditText1(edit) {
  ...
  Text1Origine.value = Text1.innerHTML;
  Text1.remove();
...
function editText2() {
  ...
  Text2.innerHTML = Text2Origine.value + '<img id="T2" class="edit" src="/img/edit.png">';
  Text2Origine.remove();
...
function reditText2(edit) {
  ...
  Text2Origine.value = Text2.innerHTML;
  Text2.remove();
...
function editText3() {
  ...
  Text3.innerHTML = Text3Origine.value + '<img id="T3" class="edit" src="/img/edit.png">';
  Text3Origine.remove();
...
function reditText3(edit) {
  ...
  Text3Origine.value = Text3.innerHTML;
  Text3.remove();
