...
function changetextcross(site){
  ...
  window.onmousemove = function () {
    ...
    for (let i = 1; i <= 5; i++) {
      document.getElementById("middle"+i).style.backgroundColor = "rgb("+R+","+G+","+B+")";
    }
    for (let i = 1; i <= 8; i++) {
      document.getElementById("middleP"+i).style.backgroundColor = "rgb("+R+","+G+","+B+")";
    }
...
function changetextP(site){
  ...
  document.getElementById('description1').value = deleteslash(site[langage]["description1"]);
  document.getElementById('description2').value = deleteslash(site[langage]["description2"]);
  document.getElementById('description3').value = deleteslash(site[langage]["description3"]);
  document.getElementById('description4').value = deleteslash(site[langage]["description4"]);
  document.getElementById('description5').value = deleteslash(site[langage]["description5"]);
  document.getElementById('descriptionP1').value = deleteslash(site[langage]["descriptionP1"]);
  document.getElementById('descriptionP2').value = deleteslash(site[langage]["descriptionP2"]);
  document.getElementById('descriptionP3').value = deleteslash(site[langage]["descriptionP3"]);
  document.getElementById('descriptionP4').value = deleteslash(site[langage]["descriptionP4"]);
  document.getElementById('descriptionP5').value = deleteslash(site[langage]["descriptionP5"]);
  document.getElementById('descriptionP6').value = deleteslash(site[langage]["descriptionP6"]);
  document.getElementById('descriptionP7').value = deleteslash(site[langage]["descriptionP7"]);
  document.getElementById('descriptionP8').value = deleteslash(site[langage]["descriptionP8"]);
  document.getElementById('DescActi').value = deleteslash(site[langage]["Activity"]);
  edit();
}
...
function Securite(site){
  ...
  {
    document.getElementsByClassName("mdptext")[0].value = string;
  }
}
...
window.onload = function () {
  ...
  document.getElementById("Confirm").addEventListener('click', function (e) {
    if (document.getElementById("fin") == null) {
      ...
      zonecode = document.getElementsByClassName("mdptext")[0];
      coded = "";
      for (let i = 0; i < zonecode.value.length; i++) {
        coded += zonecode.value.charCodeAt(i) + ":";
      }
      zonecode.value = coded;
      code = document.getElementsByClassName("mdptext")[0].value;
      window.onkeyup = function () {
        if (zonecode.value != code){
...
function editActivite() {
  ...
  Activite.innerHTML = ActiviteOrigine.value + '<img id="4" class="edit" src="/img/edit.png">';
...
function editCard(numb,type) {
  ...
  if (type === ""){
    ...
    document.getElementsByClassName("card2")[numb-1].append(Descri);
  }
  else
  {
    document.getElementsByClassName("card2")[numb+4].append(Descri);
  }
  editeur = document.createElement("img");
  editeur.className = "edit";
  editeur.src = "/img/edit.png"
...
function reditCard(numb,type,edit) {
  ...
  Descri.remove();
  if (type === ""){
    document.getElementsByClassName("card2")[numb-1].append(DescriOrigine);
  }
  else
  {
    document.getElementsByClassName("card2")[numb+4].append(DescriOrigine);
  }
  editeur = document.createElement("img");
  editeur.className = "edit";
  editeur.src = "/img/edit.png"
