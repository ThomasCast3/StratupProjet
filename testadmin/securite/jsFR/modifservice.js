...
function changetextP(site) {
  ...
  document.getElementById('text1').value = site[langage]["text1"];
  document.getElementById('text2').value = site[langage]["text2"];
}
...
window.onload = function () {
  ...
  requestURL = "/fr/jsonFR/service" + 1 + "cross.json";
  fetch(requestURL)
      .then(response => response.json())
      .then(jsonData => {
  ...
  document.getElementById("Confirm").addEventListener('click', function (e) {
    if (document.getElementById("fin") == null) {
      ...
      if (document.getElementById("photoService0").name !== "photoService0") {
        reditPhoto(document.getElementById("Photo"));
      }
...
function editPhoto() {
  for (let i = 0; i < document.getElementById("Numbimg").value; i++) {
    Photo = document.createElement("img");
    PhotoOrigine = document.getElementById("photoService"+i);
    Photo.id = PhotoOrigine.id;
    Photo.src = PhotoOrigine.value;
    Photo.className = "photoService";
    PhotoOrigine.remove();
    Div = document.createElement("div")
    Div.append(Photo);
    document.getElementById("containerPhoto").append(Div);
  }
  editeur = document.createElement("img");
  editeur.className = "edit";
  editeur.src = "https://s1.qwant.com/thumbr/0x380/b/0/becdf805fd34b4faa5c667fd83a386d47b1dc8459d37fdd89ffe1305138080/img_376363.png?u=http%3A%2F%2Fcdn.onlinewebfonts.com%2Fsvg%2Fimg_376363.png&q=0&b=1&p=0&a=0"
  editeur.id = "Photo";
  document.getElementById("imgB+").className = "hide";
  document.getElementById("imgB-").className = "hide";
  document.getElementById("editPhoto").appendChild(editeur)
  document.getElementById("Photo").addEventListener('click',function () {
    reditPhoto(this);
  })
}
function reditPhoto(edit) {
  edit.remove()
  for (let i = 0; i < document.getElementById("Numbimg").value; i++) {
    PhotoOrigine = document.createElement("textarea");
    Photo = document.getElementById("photoService" + i);
    PhotoOrigine.id = Photo.id;
    PhotoOrigine.name = PhotoOrigine.id;
    PhotoOrigine.value = Photo.src;
    Photo.remove();
    DivPM = document.createElement("div")
    DivPM.append(PhotoOrigine);
    document.getElementById("containerPhoto").append(DivPM);
  }
  editeur = document.createElement("img");
  editeur.className = "edit";
  editeur.src = "https://s1.qwant.com/thumbr/0x380/b/0/becdf805fd34b4faa5c667fd83a386d47b1dc8459d37fdd89ffe1305138080/img_376363.png?u=http%3A%2F%2Fcdn.onlinewebfonts.com%2Fsvg%2Fimg_376363.png&q=0&b=1&p=0&a=0"
  ...
  document.getElementById("imgB-").className = "";
  document.getElementById("editPhoto").append(editeur);
  editeur.addEventListener('click',function () {
    if (document.getElementById("fin") != null)
    {
      document.getElementById("fin").remove()
