...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    move_uploaded_file($_FILES['imgProduit']['tmp_name'], '../../img/Venturi.png');
    move_uploaded_file($_FILES['pdf']['tmp_name'], '../../img/brochure/Venturi.pdf');
    ...
    if(file_put_contents("$file_name", get_data())) {
        ...
        if(file_put_contents("$file_name", get_dataG())) {
            ...
            $redirect_page = '/securite/modifVenturi.html';
