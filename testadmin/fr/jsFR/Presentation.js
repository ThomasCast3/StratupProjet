...
function changetextP(site){
    ...
    document.getElementById('P1').innerHTML = site[langage]["Presentation1"];
    document.getElementById('P2').innerHTML = site[langage]["Presentation2"];
    document.getElementById('P3').innerHTML = site[langage]["Presentation3"];
}
