...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            document.getElementById("NomProd").innerHTML = "Bag filters"
...
if (langage === "Francais") {
    requestURL = "/fr/jsonFR/Filtre.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
    ...
    requestURL = "/en/jsonEN/Filtre.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            changetextP(jsonData)
...
requestURL = "/fr/jsonFR/Filtrecross.json";
fetch(requestURL)
    .then(response => response.json())
    .then(jsonData => {
...
function changetextPC(site){
    document.getElementById('imgProduit').innerHTML = `<img class="imgBrochur" src="/img/Filtre.png">`;
