...
function changetextPC(site){
    document.getElementById('imgProduit').innerHTML = `<img class="imgBrochur" src="/img/Electro">`;
...
requestURL = "/fr/jsonFR/Electrocross.json";
fetch(requestURL)
    .then(response => response.json())
    .then(jsonData => {
...
if (langage === "Francais") {
    ...
    requestURL = "/fr/jsonFR/Electro.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
    ...
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            document.getElementById("NomProd").innerHTML = "Wet/dry electrofilters"
    ...
    requestURL = "/en/jsonEN/Electro.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            changetextP(jsonData)
