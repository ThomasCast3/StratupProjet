...
function changetextPC(site) {
    document.getElementById('imgProduit').innerHTML = `<img class="imgBrochur" src="/img/Tour.png">`;
...
requestURL = "/fr/jsonFR/Tourscross.json";
fetch(requestURL)
    .then(response => response.json())
    .then(jsonData => {
...
if (langage === "Francais") {
    ...
    requestURL = "/fr/jsonFR/Tours.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
    ...
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            document.getElementById("NomProd").innerHTML = "Washing Tower"
    ...
    requestURL = "/en/jsonEN/Tours.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            changetextP(jsonData)
