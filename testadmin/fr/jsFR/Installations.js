...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            document.getElementById("NomProd").innerHTML = "“Turnkey“ installations";
...
if (langage === "Francais") {
    requestURL = "/fr/jsonFR/Installation.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
    ...
    requestURL = "/en/jsonEN/Installation.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            changetextP(jsonData)
...
requestURL = "/fr/jsonFR/Installationcross.json";
fetch(requestURL)
    .then(response => response.json())
    .then(jsonData => {
...
function changetextPC(site){
    document.getElementById('imgProduit').innerHTML = `<img class="imgBrochur" src="/img/Installation.png">`;
