...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            document.getElementById("NomProd").innerHTML = "Supply of spare parts";
...
if (langage === "Francais") {
    requestURL = "/fr/jsonFR/Fourniture.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
    ...
    requestURL = "/en/jsonEN/Fourniture.json";
    fetch(requestURL)
        .then(response => response.json())
        .then(jsonData => {
            changetextP(jsonData)
...
requestURL = "/fr/jsonFR/Fourniturecross.json";
fetch(requestURL)
    .then(response => response.json())
    .then(jsonData => {
...
function changetextPC(site){
    document.getElementById('imgProduit').innerHTML = `<img class="imgBrochur" src="/img/Fourniture.png">`;
