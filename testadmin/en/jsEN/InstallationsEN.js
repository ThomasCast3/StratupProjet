...
var requestURL = "/en/jsonEN/Installation.json";
fetch(requestURL)
  .then(response => response.json())
  .then(jsonData => {
  ...
  function changetextP(site){
    ...
    document.getElementById('imgProduit').innerHTML = `<img class="imgBrochur" src="`+ site["Anglais"]["imgProduit"] +`">`;
    document.getElementById('txtProduit').innerHTML = site["Anglais"]["txtProduit"];
    document.getElementById('lienProduit').href = site["Anglais"]["lienProduit"];
  }