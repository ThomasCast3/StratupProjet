...
var requestURL = "/en/jsonEN/presentation.json";
fetch(requestURL)
  .then(response => response.json())
  .then(jsonData => {
  ...
  function changetextP(site){
    ...
    document.getElementById('P1').innerHTML = site["Anglais"]["Presentation1"];
    document.getElementById('P2').innerHTML = site["Anglais"]["Presentation2"];
    document.getElementById('P3').innerHTML = site["Anglais"]["Presentation3"];
  }