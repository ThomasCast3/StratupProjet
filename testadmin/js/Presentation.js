...
function changetextP(site){
    ...
    document.getElementById('P1').innerHTML = deleteslash(site[langage]["Presentation1"]);
    document.getElementById('P2').innerHTML = deleteslash(site[langage]["Presentation2"]);
    document.getElementById('P3').innerHTML = deleteslash(site[langage]["Presentation3"]);
}
                ...
                .then(jsonData => {
                    ...
                    fetch(requestURL)
                        ...
                        .then(jsonData => {
                            ...
                            changetext(jsonData)
                            requestURL = "/en/jsonEN/presentation.json";
                            fetch(requestURL)
                                .then(response => response.json())
                                .then(jsonData => {
                                    changetextP(jsonData)
