...
function changetextP(site){
    document.getElementById('stxtTitre').innerHTML = deleteslash(site["Francais"]["SousTitre"]);
    document.getElementById('P1').innerHTML = deleteslash(site["Francais"]["Presentation1"]);
    document.getElementById('P2').innerHTML = deleteslash(site["Francais"]["Presentation2"]);
    document.getElementById('P3').innerHTML = deleteslash(site["Francais"]["Presentation3"]);
}
...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        ...
        .then(jsonData => {
            ...
            requestURL = "/fr/jsonFR/presentation.json";
            fetch(requestURL)
                .then(response => response.json())
                .then(jsonData => {
                    ...
                    fetch(requestURL)
                        ...
                        .then(jsonData => {
                            ...
                            fetch(requestURL)
                                .then(response => response.json())
                                .then(jsonData => {
                                    document.getElementById("presentation").innerHTML = "Why Servithen ?";
