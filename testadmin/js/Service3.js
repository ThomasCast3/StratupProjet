...
function changetextPC(site){
    ...
    for (let i = 0; i < site["Francais"]["numbimg"]; i++) {
        Photo.innerHTML = Photo.innerHTML + '<img id="photoService' + i + '" class="photoService" src="/img/Serv3-'+i+'.">';
    }
}
...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        ...
        .then(jsonData => {
            ...
            requestURL = "/fr/jsonFR/service3cross.json";
            fetch(requestURL)
                .then(response => response.json())
                .then(jsonData => {
                    ...
                    fetch(requestURL)
                        ...
                        .then(jsonData => {
                            formatG(jsonData)
                            requestURL = "/fr/jsonFR/formatService3.json";
                            fetch(requestURL)
                                .then(response => response.json())
                                .then(jsonData => {
                                    format(jsonData)
                                    ...
                                    fetch(requestURL)
                                        ...
                                        .then(jsonData => {
                                            changetext(jsonData)
                                            requestURL = "/fr/jsonFR/service3.json";
                                            fetch(requestURL)
                                                .then(response => response.json())
                                                .then(jsonData => {
                            ...
                            fetch(requestURL)
                                ...
                                .then(jsonData => {
                                    ...
                                    fetch(requestURL)
                                        .then(response => response.json())
                                        .then(jsonData => {
                                            document.getElementById("NomServ").innerHTML = "Energetic valuation";
                                            ...
                                            changetext(jsonData)
                                            requestURL = "/en/jsonEN/service3.json";
                                            fetch(requestURL)
                                                .then(response => response.json())
                                                .then(jsonData => {
                                                    changetextP(jsonData)
