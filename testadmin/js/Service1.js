...
function changetextPC(site){
    ...
    for (let i = 0; i < site["Francais"]["numbimg"]; i++) {
        Photo.innerHTML = Photo.innerHTML + '<img id="photoService' + i + '" class="photoService" src="/img/Serv1-'+i+'.">';
    }
}
...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        ...
        .then(jsonData => {
            ...
            requestURL = "/fr/jsonFR/service1cross.json";
            fetch(requestURL)
                .then(response => response.json())
                .then(jsonData => {
                    ...
                    fetch(requestURL)
                        ...
                        .then(jsonData => {
                            formatG(jsonData)
                            requestURL = "/fr/jsonFR/formatService1.json";
                            fetch(requestURL)
                                .then(response => response.json())
                                .then(jsonData => {
                                    format(jsonData)
                                    ...
                                    fetch(requestURL)
                                        ...
                                        .then(jsonData => {
                                            changetext(jsonData)
                                            requestURL = "/fr/jsonFR/service1.json";
                                            fetch(requestURL)
                                                .then(response => response.json())
                                                .then(jsonData => {
                            ...
                            fetch(requestURL)
                                ...
                                .then(jsonData => {
                                    ...
                                    fetch(requestURL)
                                        .then(response => response.json())
                                        .then(jsonData => {
                                            document.getElementById("NomServ").innerHTML = "Installation Audits and Expertise";
                                            ...
                                            changetext(jsonData)
                                            requestURL = "/en/jsonEN/service1.json";
                                            fetch(requestURL)
                                                .then(response => response.json())
                                                .then(jsonData => {
                                                    changetextP(jsonData)
