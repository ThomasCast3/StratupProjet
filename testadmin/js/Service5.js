...
function changetextPC(site){
    ...
    for (let i = 0; i < site["Francais"]["numbimg"]; i++) {
        Photo.innerHTML = Photo.innerHTML + '<img id="photoService' + i + '" class="photoService" src="/img/Serv5-'+i+'.">';
    }
}
...
if (langage === "Francais") {
    ...
    fetch(requestURL)
        ...
        .then(jsonData => {
            ...
            requestURL = "/fr/jsonFR/service5cross.json";
            fetch(requestURL)
                .then(response => response.json())
                .then(jsonData => {
                    ...
                    fetch(requestURL)
                        ...
                        .then(jsonData => {
                            formatG(jsonData)
                            requestURL = "/fr/jsonFR/formatService5.json";
                            fetch(requestURL)
                                .then(response => response.json())
                                .then(jsonData => {
                                    format(jsonData)
                                    ...
                                    fetch(requestURL)
                                        ...
                                        .then(jsonData => {
                                            changetext(jsonData)
                                            requestURL = "/fr/jsonFR/service5.json";
                                            fetch(requestURL)
                                                .then(response => response.json())
                                                .then(jsonData => {
                            ...
                            fetch(requestURL)
                                ...
                                .then(jsonData => {
                                    ...
                                    fetch(requestURL)
                                        .then(response => response.json())
                                        .then(jsonData => {
                                            document.getElementById("NomServ").innerHTML = "Preventive / curative maintenance";
                                            ...
                                            changetext(jsonData)
                                            requestURL = "/en/jsonEN/service5.json";
                                            fetch(requestURL)
                                                .then(response => response.json())
                                                .then(jsonData => {
                                                    changetextP(jsonData)
